...
$('.create-die1.button1').click(function() {
	...
	$('.ft').html('<h3>' + Math.floor((roll / 1) + 1) + '</h3>').addClass("activate");
	$('.bk').html('<h3>' + Math.floor((roll / 2) + 1) + '</h3>').addClass("activate");
	$('.rt').html('<h3>' + Math.floor((roll / 3) + 1) + '</h3>').addClass("activate");
	$('.lt').html('<h3>' + Math.floor((roll / 4) + 1) + '</h3>').addClass("activate");
	$('.bm').html('<h3>' + Math.floor((roll / 5) + 1) + '</h3>').addClass("activate");
...
$('.create-die2.button2').click(function() {
	...
	$('.intro').remove();
	// $('.roll-result').html('<h2 class="h2Class">' + gameDie.roll() + '</h2>').addClass("activate");
	$('.ft').html('<h3>' + Math.floor(roll / 1) + '</h3>').addClass("activate");
	$('.bk').html('<h3>' + Math.floor(roll / 2) + '</h3>').addClass("activate");
	$('.rt').html('<h3>' + Math.floor(roll / 3) + '</h3>').addClass("activate");
	$('.lt').html('<h3>' + Math.floor(roll / 4) + '</h3>').addClass("activate");
	$('.bm').html('<h3>' + Math.floor(roll / 5) + '</h3>').addClass("activate");
	$('.tp').html('<h3>' + gameDie.sides + '</h3>').addClass("activate");
